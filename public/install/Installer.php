...
class Installer
{
    ...
    public function validateCsrfToken(#[SensitiveParameter] string $token): bool
    {
    ...
    public function testDatabaseConnection(string $host, int $port, string $name, string $user, #[SensitiveParameter] string $password): bool
    {
        try {
    ...
    public function runComposerInstall(): bool
    {
        ...
        $command = sprintf('cd %s && composer install --no-dev --optimize-autoloader 2>&1', escapeshellarg($projectRoot));
    ...
    public function createAdminUser(PDO $pdo, string $email, #[SensitiveParameter] string $password, string $name): int
    {
