...
readonly class Runner implements CronTaskInterface
{
    ...
    public function runCronTask(OutputInterface $output): CronTaskResult
    {
        ...
        return new CronTaskResult(self::IDENTIFIER, $worst, sprintf('hotfixes: %d ran, %d skipped, %d failed', $ran, $skipped, $failed));
    }
}
