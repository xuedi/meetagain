...
/**
 * Threshold of 5 hits/IP/window: a legitimate user fat-fingering a permission
 * a couple of times is normal; 5 in one window crosses into adversarial.
 */
final readonly class AccessDeniedIncidentSource implements IncidentSourceInterface
{
    public const string KEY = IncidentSourceContribution::KEY_ACCESS_DENIED;
    public const string KEY_LAST_PROCESSED_ID = 'security.incident.access_denied.last_processed_log_id';
    public const int SETTLE_MINUTES = 5;
    public const int MIN_HITS_PER_INCIDENT = 5;
