...
class CompletedHandover extends MessageAbstract
{
    public const string TYPE = 'core.circulation_completed_handover';
    ...
    {
        return $this->translator->trans('profile_social.activity_circulation_completed', [
    ...
    protected function renderHtml(): string
    {
        ...
        return $this->translator->trans('profile_social.activity_circulation_completed', ['%circulation%' => $link]);
    }
}
