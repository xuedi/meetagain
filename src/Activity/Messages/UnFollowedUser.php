...
class UnFollowedUser extends MessageAbstract
{
    ...
    protected function renderText(): string
    {
        ...
        if ($userName === null) {
            return $this->translator->trans('profile_social.activity_unfollowed_user_deleted');
        }

        return $this->translator->trans('profile_social.activity_unfollowed_user', ['%user%' => $userName]);
    }
    ...
    protected function renderHtml(): string
    {
        ...
        return $this->translator->trans('profile_social.activity_unfollowed_user', ['%user%' => $link]);
    }
}
