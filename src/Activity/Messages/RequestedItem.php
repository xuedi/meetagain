...
class RequestedItem extends MessageAbstract
{
    public const string TYPE = 'core.circulation_requested_item';
    ...
    {
        return $this->translator->trans('profile_social.activity_circulation_requested', [
    ...
    protected function renderHtml(): string
    {
        ...
        return $this->translator->trans('profile_social.activity_circulation_requested', ['%circulation%' => $link]);
    }
}
