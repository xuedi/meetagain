...
class AdminCmsBlockDeleted extends MessageAbstract
{
    public const string TYPE = 'core.admin_cms_block_deleted';
    ...
    {
        return $this->translator->trans('profile_social.activity_admin_cms_block_deleted', [
