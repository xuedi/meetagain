    ...
    private function getData(): array
    {
        ...
        return [
            ...
            [
                '2025-03-04 10:00:00',
                UserFixture::ADMIN,
                AdminEventDeleted::TYPE,
                ['event_id' => 999, 'event_name' => 'Old Meetup'],
            ],
            [
                '2025-03-05 10:00:00',
                UserFixture::ADMIN,
                AdminCmsPageCreated::TYPE,
                ['cms_id' => $aboutCmsId, 'cms_slug' => CmsFixture::ABOUT],
            ],
            [
                '2025-03-06 10:00:00',
                UserFixture::ADMIN,
                AdminCmsPageUpdated::TYPE,
                ['cms_id' => $aboutCmsId, 'cms_slug' => CmsFixture::ABOUT],
            ],
            [
                '2025-03-07 10:00:00',
                UserFixture::ADMIN,
                AdminCmsPageDeleted::TYPE,
                ['cms_id' => 999, 'cms_slug' => 'old-page'],
            ],
