...
class CmsBlockFixture extends AbstractFixture implements DependentFixtureInterface
{
    ...
    private function getData(): array
    {
        return [
            ...
            [
                CmsFixture::DIRECTIONS,
                LanguageFixture::ENGLISH,
                CmsBlockType::TextMap,
                [
                    'title' => 'How to find us',
                    'content' => 'We meet at the Weiqi Cafe on Brunnenstraße, a five minute walk from Bernauer Straße underground station. Ring the bell marked "Go Club" and take the stairs to the first floor.',
                    'latitude' => 52.5321,
                    'longitude' => 13.3799,
                    'zoom' => 16,
                    'markerLabel' => LocationFixture::WEIQI_CAFE,
                    'mapPosition' => 'right',
                    'mapWidth' => 'third',
                    'mapHeight' => 'medium',
                ],
            ...
            [
                ...
                [
                    ...
                    'content' => 'Wir treffen uns im Weiqi Cafe in der Brunnenstraße, fünf Gehminuten vom U-Bahnhof Bernauer Straße entfernt. Klingle bei "Go Club" und nimm die Treppe in den ersten Stock.',
                    'latitude' => 52.5321,
                    'longitude' => 13.3799,
                    'zoom' => 16,
                    'markerLabel' => LocationFixture::WEIQI_CAFE,
            ...
            [
                ...
                [
                    'title' => '如何找到我们',
                    'content' => '我们在布伦嫩街的围棋咖啡馆聚会，从贝尔瑙尔街地铁站步行五分钟即可到达。请按写着 "Go Club" 的门铃，然后上楼到二层。',
                    'latitude' => 52.5321,
                    'longitude' => 13.3799,
                    'zoom' => 16,
                    'markerLabel' => LocationFixture::WEIQI_CAFE,
            ...
            [
                ...
                [
                    ...
                    'content' => 'Nous nous retrouvons au Weiqi Cafe, Brunnenstraße, à cinq minutes à pied de la station de métro Bernauer Straße. Sonnez à "Go Club" et montez au premier étage.',
                    'latitude' => 52.5321,
                    'longitude' => 13.3799,
                    'zoom' => 16,
                    'markerLabel' => LocationFixture::WEIQI_CAFE,
            ...
            [
                ...
                [
                    ...
                    'content' => 'Nos reunimos en el Weiqi Cafe de la Brunnenstraße, a cinco minutos a pie de la estación de metro Bernauer Straße. Llama al timbre "Go Club" y sube a la primera planta.',
                    'latitude' => 52.5321,
                    'longitude' => 13.3799,
                    'zoom' => 16,
                    'markerLabel' => LocationFixture::WEIQI_CAFE,
