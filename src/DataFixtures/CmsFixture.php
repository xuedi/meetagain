...
class CmsFixture extends AbstractFixture implements DependentFixtureInterface
{
    ...
    private function createTitles(ObjectManager $manager): void
    {
        $titles = [
            ...
            [self::INDEX, 'fr', 'MeetAgain - Gestion d\'événements'],
            [self::INDEX, 'es', 'MeetAgain - Gestión de eventos'],
            [self::PRIVACY, 'en', 'Privacy Policy'],
            [self::PRIVACY, 'de', 'Datenschutzerklärung'],
            [self::PRIVACY, 'zh', '隐私政策'],
            [self::PRIVACY, 'fr', 'Politique de confidentialité'],
            [self::PRIVACY, 'es', 'Política de privacidad'],
            [self::ABOUT, 'en', 'About Us'],
            [self::ABOUT, 'de', 'Über uns'],
            [self::ABOUT, 'zh', '关于我们'],
            [self::ABOUT, 'fr', 'À propos de nous'],
            [self::ABOUT, 'es', 'Sobre nosotros'],
            ...
            [self::IMPRINT, 'fr', 'Mentions légales'],
            [self::IMPRINT, 'es', 'Aviso legal'],
            ...
            [self::ANNOUNCEMENT, 'fr', 'Nouvelle version du site publiée !'],
            [self::ANNOUNCEMENT, 'es', '¡Nueva versión del sitio web publicada!'],
        ];
    ...
    private function createLinkNames(ObjectManager $manager): void
    {
        $linkNames = [
            ...
            [self::INDEX, 'zh', '首页'],
            [self::INDEX, 'fr', 'Accueil'],
            [self::INDEX, 'es', 'Inicio'],
            [self::PRIVACY, 'en', 'Privacy'],
            [self::PRIVACY, 'de', 'Datenschutz'],
            [self::PRIVACY, 'zh', '隐私'],
            [self::PRIVACY, 'fr', 'Confidentialité'],
            [self::PRIVACY, 'es', 'Privacidad'],
            [self::ABOUT, 'en', 'About'],
            [self::ABOUT, 'de', 'Über uns'],
            [self::ABOUT, 'zh', '关于'],
            [self::ABOUT, 'fr', 'À propos'],
            [self::ABOUT, 'es', 'Nosotros'],
            [self::RULES, 'en', 'Rules'],
            ...
            [self::ANNOUNCEMENT, 'fr', 'Actualités'],
            [self::ANNOUNCEMENT, 'es', 'Noticias'],
        ];
