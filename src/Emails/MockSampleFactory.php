...
readonly class MockSampleFactory
{
    ...
    private const array WORLDS = [
        'en' => [
            ...
            'announcementBody' => '<p>From September the Wednesday conversation table moves to Instituto Hispano Berlin.</p><p>Same time, two streets further along - see you there.</p>',
        ...
        'de' => [
            ...
            'announcementBody' => '<p>Ab September läuft der zweiwöchentliche Filmabend im Kino Central.</p><p>Gleiche Uhrzeit, zwei Straßen weiter - bis dann.</p>',
        ...
        'zh' => [
            ...
            'announcementBody' => '<p>从九月起，中文短语交流会将在 Long Jing Teahouse 举行。</p><p>时间不变，欢迎大家继续参加。</p>',
        ...
        'fr' => [
            ...
            'announcementBody' => '<p>À partir de septembre, le supper club se tiendra à la Schöneberg Garden House.</p><p>Même heure, deux rues plus loin - à bientôt.</p>',
        ...
        'es' => [
            ...
            'announcementBody' => '<p>Desde septiembre la mesa de conversación se traslada al Bar La Esquina.</p><p>Misma hora, dos calles más allá. ¡Nos vemos!</p>',
