    ...
    private function getEndpointDefinitions(): array
    {
        return [
            [
                ...
                'badge' => null,
                'endpoints' => [
                    ['method' => 'GET', 'apiPath' => '/api/status',       'description' => 'Service health check',    'example' => 'curl HOST/api/status',       'route' => null],
                    ['method' => 'GET', 'apiPath' => '/api/translations',  'description' => 'Translation strings',     'example' => 'curl HOST/api/translations',  'route' => 'app_api_translations'],
                    ['method' => 'GET', 'apiPath' => '/api/glossary',      'description' => 'Glossary data',           'example' => 'curl HOST/api/glossary',      'route' => 'app_api_glossary'],
                ],
            ],
            [
                ...
                'endpoints' => [
                    [
                        'method' => 'POST', 'apiPath' => '/api/auth/token', 'route' => null,
                    ...
                    [
                        'method' => 'DELETE', 'apiPath' => '/api/auth/token', 'route' => null,
            ...
            [
                ...
                'endpoints' => [
                    ...
                    [
                        'method' => 'GET', 'apiPath' => '/api/cms/{id}', 'route' => null,
                        'description' => 'Get full page with blocks',
                        'example' => "curl HOST/api/cms/1 \\\n  -H \"Authorization: Bearer \$TOKEN\"",
                    ],
                    [
                        'method' => 'POST', 'apiPath' => '/api/cms/', 'route' => null,
                    ...
                    [
                        'method' => 'PUT', 'apiPath' => '/api/cms/{id}', 'route' => null,
                    ...
                    [
                        'method' => 'DELETE', 'apiPath' => '/api/cms/{id}', 'route' => null,
            ...
            [
                ...
                'endpoints' => [
                    ...
                    [
                        'method' => 'PUT', 'apiPath' => '/api/cms/{id}/blocks/{blockId}', 'route' => null,
                    ...
                    [
                        'method' => 'DELETE', 'apiPath' => '/api/cms/{id}/blocks/{blockId}', 'route' => null,
