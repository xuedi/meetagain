...
final class Version20260820013000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(
            'ALTER TABLE support_request ADD CONSTRAINT FK_86A287633D617FB6 FOREIGN KEY (invited_admins_by_id) REFERENCES `user` (id) ON DELETE SET NULL',
        );
        $this->addSql(
            'ALTER TABLE support_message ADD CONSTRAINT FK_B88388360CA7C87 FOREIGN KEY (support_request_id) REFERENCES support_request (id) ON DELETE CASCADE',
        );
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql(
            'ALTER TABLE support_request ADD CONSTRAINT FK_SUPPORT_REQUEST_RESPONDED_BY FOREIGN KEY (responded_by_id) REFERENCES `user` (id) ON DELETE SET NULL',
        );
    }
}
