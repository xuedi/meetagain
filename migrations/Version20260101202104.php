...
final class Version20260101202104 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql(
            'ALTER TABLE email_queue CHANGE status status VARCHAR(20) DEFAULT \'pending\' NOT NULL, CHANGE template template VARCHAR(255) DEFAULT NULL',
        );
