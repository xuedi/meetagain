...
final class Version20260102200243 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(
            'CREATE TABLE email_template_translation (id INT AUTO_INCREMENT NOT NULL, language VARCHAR(2) NOT NULL, subject VARCHAR(255) NOT NULL, body LONGTEXT NOT NULL, updated_at DATETIME NOT NULL, email_template_id INT NOT NULL, INDEX IDX_71F8068D131A730F (email_template_id), UNIQUE INDEX UNIQ_71F8068DD4DB71B5131A730F (language, email_template_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4',
        );
        $this->addSql(
            'ALTER TABLE email_template_translation ADD CONSTRAINT FK_71F8068D131A730F FOREIGN KEY (email_template_id) REFERENCES email_template (id)',
        );

        // Migrate existing data to English translations
        $this->addSql(
            "INSERT INTO email_template_translation (email_template_id, language, subject, body, updated_at) SELECT id, 'en', subject, body, updated_at FROM email_template",
        );
