...
final class Version20260226000001 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql("UPDATE email_queue SET template = 'notification_rsvp_aggregated' WHERE template = 'notification_rsvp'");
    }

    public function down(Schema $schema): void
    {
        $this->addSql("UPDATE email_queue SET template = 'notification_rsvp' WHERE template = 'notification_rsvp_aggregated'");
        $this->addSql(
