...
final class Version20260214200133 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql(
            'CREATE TABLE menu (id INT AUTO_INCREMENT NOT NULL, location INT NOT NULL, priority DOUBLE PRECISION NOT NULL, visibility INT NOT NULL, type INT NOT NULL, slug VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_uca1400_ai_ci`, route VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_uca1400_ai_ci`, cms_id INT DEFAULT NULL, event_id INT DEFAULT NULL, INDEX IDX_7D053A93BE8A7CFB (cms_id), INDEX IDX_7D053A9371F7E88B (event_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_uca1400_ai_ci` ENGINE = InnoDB COMMENT = \'\' ',
        );
        $this->addSql(
            'CREATE TABLE menu_translation (id INT AUTO_INCREMENT NOT NULL, language VARCHAR(2) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_uca1400_ai_ci`, name VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_uca1400_ai_ci`, menu_id INT NOT NULL, INDEX IDX_DC955B23CCD7E912 (menu_id), UNIQUE INDEX UNIQ_DC955B23D4DB71B5CCD7E912 (language, menu_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_uca1400_ai_ci` ENGINE = InnoDB COMMENT = \'\' ',
        );
