...
final class Version20260727120000 extends AbstractMigration
{
    ...
    {
        $this->addSql(
            'CREATE TABLE logs_suspicious_url (id INT AUTO_INCREMENT NOT NULL, url VARCHAR(2048) NOT NULL, created_at DATETIME NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4',
        );
    }
