...
final class Version20260215033931 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(
            'CREATE TABLE cms_link_name (id INT AUTO_INCREMENT NOT NULL, language VARCHAR(2) NOT NULL, name VARCHAR(255) NOT NULL, cms_id INT NOT NULL, INDEX IDX_2C028CC2BE8A7CFB (cms_id), UNIQUE INDEX UNIQ_2C028CC2D4DB71B5BE8A7CFB (language, cms_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4',
        );
        $this->addSql(
            'CREATE TABLE cms_title (id INT AUTO_INCREMENT NOT NULL, language VARCHAR(2) NOT NULL, title VARCHAR(255) NOT NULL, cms_id INT NOT NULL, INDEX IDX_545E347BE8A7CFB (cms_id), UNIQUE INDEX UNIQ_545E347D4DB71B5BE8A7CFB (language, cms_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4',
        );
