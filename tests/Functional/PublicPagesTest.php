...
class PublicPagesTest extends WebTestCase
{
    ...
    public function testRobotsTxtContainsAiCrawlerBlocksAndContentSignal(): void
    {
        ...
        static::assertStringContainsString('User-agent: AIBot', $content);
        ...
        static::assertStringNotContainsString('AI-Web', $content, 'AI-Web is deprecated and must not appear');
        static::assertStringNotContainsString('generic-ai', $content, 'generic-ai is deprecated and must not appear');
    }
