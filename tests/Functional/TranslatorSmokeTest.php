...
class TranslatorSmokeTest extends WebTestCase
{
    ...
    private const array KNOWN_NAMESPACES = [
        ...
        'multisite_features',
        'multisite_pricing',
        'multisite_open_source',
        'multisite_hosted_at',
        'multisite_portal',
        'multisite_my_groups',
        'multisite_my_group_whitelabel',
        'multisite_tiles',
        'multisite_group_application',
        'multisite_billing',
        'multisite_checkout',
        'multisite_account_purchases',
        'multisite_group_admin',
        'multisite_group_admin_profile',
        'multisite_group_admin_languages',
        'multisite_group_admin_email',
        'multisite_group_admin_social',
        'multisite_group_admin_seo',
        'multisite_group_admin_plugins',
        'multisite_group_admin_export',
        'multisite_group_admin_subscription',
        'multisite_group_admin_domain',
        'multisite_meta_admin',
        'multisite_meta_settings',
        'multisite_meta_groups',
        'multisite_meta_featured',
        'multisite_meta_users',
        'multisite_meta_cms_pages',
        'multisite_meta_integrity',
        'multisite_meta_logs',
        'multisite_meta_logs_billing',
        'multisite_meta_logs_activity',
        'multisite_meta_subscriptions',
        'multisite_meta_key_accounts',
        'multisite_meta_user_subscriptions',
        'multisite_admin_member',
        'multisite_activity',
        'multisite_notifications',
        'multisite_email',
    ];
