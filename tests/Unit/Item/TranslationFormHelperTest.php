...
class TranslationFormHelperTest extends TestCase
{
    ...
    private function helper(array $codes): TranslationFormHelper
    {
        $languageService = $this->createStub(LanguageService::class);
        $languageService->method('getAdminFilteredEnabledCodes')->willReturn($codes);

        return new TranslationFormHelper($languageService);
    }
}
