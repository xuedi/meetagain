...
class TaxonomyPortabilityTest extends TestCase
{
    ...
    public function testImportRekeysThroughTheRefMap(): void
    {
        ...
        $categoryWrites = [];
        $tagWrites = [];
        $service = $this->createStub(TaxonomyService::class);
     ...
     */
    private function taxonomy(array $categoryIds, array $tagIds): Config
    {
        return new Config()
    ...
    private function makePortability(
        ...
        return new TaxonomyPortability(
            ...
            taxonomyService: $service ?? $this->createStub(TaxonomyService::class),
            registry: $registry,
        );
    }
}
