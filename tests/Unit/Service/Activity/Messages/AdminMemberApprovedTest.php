...
class AdminMemberApprovedTest extends TestCase
{
    ...
    public function testCanBuild(): void
    {
        ...
        static::assertEquals('profile_social.activity_admin_member_approved', $subject->render());
        static::assertEquals('profile_social.activity_admin_member_approved', $subject->render(true));
    }
    ...
    public function testRendersDeletedUserGracefully(): void
    {
        ...
        // Act & Assert
        static::assertSame('profile_social.activity_admin_member_approved_deleted', $subject->render());
    }
    ...
    {
        // Arrange
        $this->expectExceptionObject(new InvalidArgumentException("Value 'user_id' has to be numeric in 'core.admin_member_approved'"));
