...
class FollowedUserTest extends TestCase
{
    ...
    public function testCanBuild(): void
    {
        $userId = 42;
        $userName = 'testUser';
        $expectedText = 'profile_social.activity_followed_user';
        $expectedHtml = 'profile_social.activity_followed_user';
    ...
    public function testRendersDeletedUserGracefully(): void
    {
        ...
        static::assertSame('profile_social.activity_followed_user_deleted', $subject->render());
        static::assertSame('profile_social.activity_followed_user_deleted', $subject->render(true));
    }
