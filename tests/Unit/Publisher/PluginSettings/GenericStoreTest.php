...
class GenericStoreTest extends TestCase
{
    ...
    private function store(PluginSettingsRepository $repo, EntityManagerInterface $em): GenericStore
    {
        return new GenericStore($repo, $em, new PluginSettingsService([new StubDescriptor('stub')]));
    }
}
