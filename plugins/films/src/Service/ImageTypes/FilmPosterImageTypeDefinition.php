...
namespace Plugin\Films\Service\ImageTypes;
...
final class FilmPosterImageTypeDefinition extends AbstractImageTypeDefinition
{
    ...
    {
        return ['route' => 'app_plugin_films_film_show', 'params' => ['id' => $locationId]];
    }

    public function discoverImageIds(): array
    {
        $rows = $this->connection->fetchAllAssociative(
            'SELECT poster_image_id AS image_id, id AS location_id FROM plg_films_film WHERE poster_image_id IS NOT NULL',
        );
