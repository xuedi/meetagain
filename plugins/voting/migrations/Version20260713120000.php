...
final class Version20260713120000 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE plg_voting_poll (
            ...
            INDEX IDX_CF9B452971F7E88B (event_id),
            PRIMARY KEY(id)
        ) DEFAULT CHARACTER SET utf8mb4');

        $this->addSql('CREATE TABLE plg_voting_poll_option (
            id INT AUTO_INCREMENT NOT NULL,
            poll_id INT NOT NULL,
            item_id INT NOT NULL,
            INDEX IDX_2EFDE8F23C947C0F (poll_id),
            UNIQUE INDEX uniq_poll_option_poll_item (poll_id, item_id),
            PRIMARY KEY(id)
        ) DEFAULT CHARACTER SET utf8mb4');

        $this->addSql('CREATE TABLE plg_voting_vote (
            id INT AUTO_INCREMENT NOT NULL,
            poll_id INT NOT NULL,
            user_id INT NOT NULL,
            item_id INT NOT NULL,
            voted_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\',
            INDEX IDX_11373A083C947C0F (poll_id),
    ...
    {
        $this->addSql('ALTER TABLE plg_voting_poll_option DROP FOREIGN KEY FK_2EFDE8F23C947C0F');
        $this->addSql('ALTER TABLE plg_voting_vote DROP FOREIGN KEY FK_11373A083C947C0F');
        $this->addSql('ALTER TABLE plg_voting_poll DROP FOREIGN KEY FK_CF9B452971F7E88B');
        $this->addSql('DROP TABLE plg_voting_vote');
        $this->addSql('DROP TABLE plg_voting_poll_option');
        $this->addSql('DROP TABLE plg_voting_poll');
    }
}
