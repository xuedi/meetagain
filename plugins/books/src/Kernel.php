...
use Plugin\Books\Service\FixtureCoverService;
...
class Kernel implements Plugin
{
    public function __construct(
        ...
        private readonly FixtureCoverService $fixtureCoverService,
    ) {}
    ...
    public function loadPostExtendFixtures(OutputInterface $output): void
    {
        ...
        $catalog = [
            ['978-0143105428', 'The Odyssey',           'Homer',           'The wanderings of Odysseus on his way home from Troy.',      541, 2006, 'the-odyssey-2006.jpg'],
            ['978-0141439518', 'Pride and Prejudice',   'Jane Austen',     'Elizabeth Bennet navigates manners, morality and marriage.', 480, 2003, 'pride-and-prejudice-2003.jpg'],
            ['978-0060850524', 'Brave New World',       'Aldous Huxley',   'A dystopia of engineered contentment.',                      288, 2006, 'brave-new-world-2006.jpg'],
            ['978-0060935467', 'To Kill a Mockingbird', 'Harper Lee',      'A lawyer defends a black man in the Depression-era South.',  336, 2002, 'to-kill-a-mockingbird-2002.jpg'],
            ['978-0143039433', 'East of Eden',          'John Steinbeck',  'Two families retrace the story of the fall from Eden.',      601, 2002, 'east-of-eden-2002.jpg'],
            ['978-0140283334', 'On the Road',           'Jack Kerouac',    'A restless cross-country search for meaning.',               307, 1999, 'on-the-road-1999.jpg'],
            ['978-0140177398', 'Of Mice and Men',       'John Steinbeck',  'Two drifters chase a dream during the Great Depression.',    112, 1993, 'of-mice-and-men-1993.jpg'],
            ['978-0142437209', 'Moby-Dick',             'Herman Melville', 'Captain Ahab pursues the white whale.',                      720, 2003, 'moby-dick-2003.jpg'],
        ];

        $created = [];
        foreach ($catalog as [$isbn, $title, $author, $description, $pageCount, $publishedYear, $cover]) {
            $book = $this->bookService->createManual($isbn, $title, $author, $description, $pageCount, $publishedYear, $adminId);
            $this->fixtureCoverService->attach($book, $cover, $admin);
            $created[] = $book;
        }
