...
class ImageSuggestionApproved extends MessageAbstract
{
    public const string TYPE = 'dinnerclub.image_suggestion_approved';
    ...
    {
        return sprintf(
            'Approved image suggestion (%s) for dish: <strong>%s</strong>',
