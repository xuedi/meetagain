...
class ImageSuggestionRejected extends MessageAbstract
{
    public const string TYPE = 'dinnerclub.image_suggestion_rejected';
    ...
    {
        return sprintf(
            'Rejected image suggestion (%s) for dish: <strong>%s</strong>',
