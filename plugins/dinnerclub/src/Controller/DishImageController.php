...
final class DishImageController extends AbstractController
{
    ...
    public function upload(Request $request, int $id): Response
    {
        ...
        if ($this->isGranted('ROLE_ORGANIZER')) {
            ...
            return $this->redirect($this->getReturnUrl($request, $this->generateUrl('plugin_dinnerclub_item_show', [
                'id' => $id,
            ])));
        }
    ...
    #[Route('/delete/{dishImageId}', name: 'plugin_dinnerclub_image_delete', methods: ['POST'])]
