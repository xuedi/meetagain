...
use Plugin\Dinnerclub\Form\DishListType;
...
final class ListController extends AbstractController
{
    ...
    public function index(): Response
    {
        ...
        return $this->render('@Dinnerclub/lists/index.html.twig', [
            'myLists' => $this->listService->getUserLists($user->getId()),
            'publicLists' => $this->listService->getPublicListsByOthers($user->getId()),
        ]);
    }

    #[Route('/create', name: 'plugin_dinnerclub_lists_create', methods: ['GET', 'POST'])]
    public function create(Request $request): Response
    {
        ...
        return $this->render('@Dinnerclub/lists/create.html.twig', [
            'form' => $form,
        ]);
    }

    #[Route('/edit/{id}', name: 'plugin_dinnerclub_lists_edit', methods: ['GET', 'POST'])]
    public function edit(Request $request, int $id): Response
    {
        ...
        return $this->render('@Dinnerclub/lists/edit.html.twig', [
            'form' => $form,
            'list' => $list,
        ]);
    }

    #[Route('/view/{id}', name: 'plugin_dinnerclub_lists_view', methods: ['GET'])]
    public function view(int $id): Response
    {
        ...
        return $this->render('@Dinnerclub/lists/view.html.twig', [
            'list' => $list,
            'dishes' => $dishes,
    ...
    #[Route('/{listId}/add/{dishId}', name: 'plugin_dinnerclub_lists_add_dish', methods: ['POST'])]
    ...
    #[Route('/{listId}/remove/{dishId}', name: 'plugin_dinnerclub_lists_remove_dish', methods: ['POST'])]
